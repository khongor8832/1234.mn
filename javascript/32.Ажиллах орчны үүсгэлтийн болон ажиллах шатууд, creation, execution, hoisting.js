...
var b = 12;
console.log(b);
/********************* Function HOISTING ЖИШЭЭ КОДООР ҮЗЭХ *************/

// hoisting ==> function declaration statment
x(); //Функцын дээрээс ягаад дуудаж болж байна вэ. Үүсгэлтийн шат эхлэхээс өмнө дотор нь умар функцууд байна гэж хайж олоод x гэдэг функц байна гэдгийг мэдэнгүүтээ хувьсагчын объектын орон зайд ийм console.log('x бол функц'); байрлуулчихсан байдаг.
function x() {
...
// function expression
// y(); //дуудаж болохгүй байна. Ягаад гэвэл хувьсагчинд функц өгсөн. Санах ойд y = undefined байрлуулчихсан байгаа болохоор
var y = function () {
  console.log("y function exxpression"); // анхнаасаа байсан javascript  1,0 хувилбараасаа ахуулаад  энэ бичиглэлээр бичиж байсан. Энэний ачаар хувьсагчид функц өгч гайхамшигтай илбийн ут шиг код бичих болсон.
};
y();

// expression-ы функцан дотороос функц дуудах,  функцаар дамжуулж функц дуудах
function m(p) {
  p(); // p функцыг дуудаж байна.
...
}; // Дээрээс нь дуудаж болохгүй юм шиг дутагдалтай иөртлөө функцуудыг давхар дуудаж ажиллуулдагаараа гайхалтай.
m(z); // z функцыг дуудаж байна.
m(p);
